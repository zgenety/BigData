...
CREATE EXTERNAL TABLE IF NOT EXISTS metrics_part (
    date_time TIMESTAMP,
    aqi DECIMAL(5, 1),
    so2 DECIMAL(5, 1),
    co DECIMAL(5, 2),
...
PARTITIONED BY (sid INT) STORED AS AVRO LOCATION 'project/hive/warehouse/metrics_part' TBLPROPERTIES ('AVRO.COMPRESS'='SNAPPY');

INSERT INTO metrics_part partition (sid) SELECT
